...
public class SyncUtils
{
    ...
    public static void CreateSyncAccount(Context context, String accountName)
    {
        ...
        Account account = SecurityService.GetAccount(accountName, SecurityConstants.ACCOUNT_TYPE);
    ...
    public static void syncNow(String accountName)
    {
        ...
        ContentResolver.requestSync(SecurityService.GetAccount(accountName, SecurityConstants.ACCOUNT_TYPE),
