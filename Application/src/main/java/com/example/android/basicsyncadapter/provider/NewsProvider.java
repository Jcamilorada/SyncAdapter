...
public class NewsProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case MULTIPLES_RECORD_ID:
                return NewsContract.NewsItemConstants.CONTENT_TYPE;
            case SINGLE_RECORDS_ID:
                return NewsContract.NewsItemConstants.CONTENT_ITEM_TYPE;
            default:
        ...
        String sortOrder)
    {
        ...
        switch (uriMatch) {
            case SINGLE_RECORDS_ID:
                ...
                builder.where(NewsContract.NewsItemConstants._ID + "=?", id);
            case MULTIPLES_RECORD_ID:
                builder.table(NewsContract.NewsItemConstants.TABLE_NAME).where(selection, selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case MULTIPLES_RECORD_ID:
                long id = db.insertOrThrow(NewsContract.NewsItemConstants.TABLE_NAME, null, values);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        {
            case MULTIPLES_RECORD_ID:
                count = builder.table(NewsContract.NewsItemConstants.TABLE_NAME)
            ...
            case SINGLE_RECORDS_ID:
                String id = uri.getLastPathSegment();
                count = builder.table(NewsContract.NewsItemConstants.TABLE_NAME)
                       .where(NewsContract.NewsItemConstants._ID + "=?", id)
                       .where(selection, selectionArgs)
                       .delete(db);
                break;
            default:
